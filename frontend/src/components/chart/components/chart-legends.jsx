...
export function ChartLegends({
  ...
  return <ListRoot className={mergeClasses([chartClasses.legends.root, className])} sx={sx} {...other}>
      {labels.map((series, index) => <ItemWrap
    key={series}
  ...
  >
          <ItemRoot className={chartClasses.legends.item.root} {...slotProps?.root}>
            {icons.length ? <ItemIcon className={chartClasses.legends.item.icon} {...slotProps?.icon}>
                {icons[index]}
              </ItemIcon> : <ItemDot className={chartClasses.legends.item.dot} {...slotProps?.dot} />}
          ...
          {values && <ItemValue className={chartClasses.legends.item.value} {...slotProps?.value}>
              {values[index]}
            </ItemValue>}
        </ItemWrap>)}
    </ListRoot>;
