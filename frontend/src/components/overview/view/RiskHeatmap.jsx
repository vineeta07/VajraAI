  ...
  const onEachFeature = (feature, layer) => {
    layer.on({
      mouseover: (e) => {
        ...
        e.target.setStyle({ fillOpacity: 0.85, weight: 3, color: '#2196f3' });
      },
      mouseout: (e) => {
        setHoveredWard(null);
    ...
    layer.bindTooltip(
      ...
      { permanent: false, sticky: true, className: 'custom-tooltip', direction: 'top', opacity: 0.95 }
    );
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h4 style={{ fontWeight: 700, fontSize: '14px', color: 'white', margin: 0 }}>Risk Heatmap</h4>
        </div>
          ...
          {legendItems.map(item => (
            ...
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                <span style={{ fontSize: '13px', fontWeight: 600, color: item.textColor, lineHeight: 1.2 }}>
                  {item.label}
                </span>
      ...
      <MapContainer center={mapCenter} zoom={11} style={{ height: '100%', width: '100%' }} zoomControl={false}>
        ...
        {selectedWard && (
          <Popup position={mapCenter} closeButton maxWidth={280} minWidth={240}>
            <div style={{ padding: '16px', fontFamily: 'system-ui, sans-serif' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '18px', fontWeight: 600, color: '#ef4444' }}>{selectedWard.riskScore}%</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '18px', fontWeight: 600, color: '#f97316' }}>{selectedWard.anomalies}</span>
                </div>
              </div>
            </div>
          </Popup>
