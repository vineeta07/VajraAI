...
export const _langs = [
 {
    value: 'en',
    label: 'English',
    icon: '/assets/icons/flags/english.svg',
  },
  {
    value: 'hi',
    label: 'Hindi',
    icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7-PIY6k81xkBEOH_aXcaBZOiCjxWgQ1RXzA&s',
  },
  {
    value: 'ta',
    label: 'Tamil',
    icon: '/assets/icons/flags/tamil.svg',
  },
];
