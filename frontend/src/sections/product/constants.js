import { SchemeType, RiskStatus } from "./types";
...
export const MOCK_RISKS = Array.from({ length: 50 }).map((_, i) => ({
  id: `risk-${i}`,
  tenderId: `TND-${1e3 + i}`,
  ...
  amount: Math.floor(Math.random() * 5e6) + 1e5,
