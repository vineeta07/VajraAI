...
export function UserView() {
  ...
  const filteredData = citizenData.filter(
    (row) => row.id.toLowerCase().includes(filterName.toLowerCase()) || row.reason.toLowerCase().includes(filterName.toLowerCase()) || row.district.toLowerCase().includes(filterName.toLowerCase())
  );
  ...
  />
              <TableBody>
                {filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => <UserTableRow
    key={row.id}
    row={row}
