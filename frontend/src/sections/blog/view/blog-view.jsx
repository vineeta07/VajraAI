...
const fraudPosts = [
  ...
  },
  {
    ...
    totalShares: 1423,
    totalFavorites: 1950,
    postedAt: new Date(Date.now() - 864e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 892,
    totalFavorites: 1340,
    postedAt: new Date(Date.now() - 1728e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 1678,
    totalFavorites: 2150,
    postedAt: new Date(Date.now() - 2592e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 1234,
    totalFavorites: 1780,
    postedAt: new Date(Date.now() - 3456e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 723,
    totalFavorites: 1120,
    postedAt: new Date(Date.now() - 432e6).toISOString(),
  ...
  },
  {
    ...
    totalShares: 567,
    totalFavorites: 890,
    postedAt: new Date(Date.now() - 5184e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 1456,
    totalFavorites: 2010,
    postedAt: new Date(Date.now() - 6048e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 1089,
    totalFavorites: 1560,
    postedAt: new Date(Date.now() - 6912e5).toISOString(),
  ...
  },
  {
    ...
    totalShares: 1345,
    totalFavorites: 1789,
    postedAt: new Date(Date.now() - 7776e5).toISOString(),
