...
const fraudAlerts = [
  { id: "1", title: "\u20B912.4 Cr saved by blocking ghost pensioners in Narela district", coverUrl: "/assets/images/cover/cover-1.webp", totalViews: 1420, postedAt: /* @__PURE__ */ new Date(), author: { avatarUrl: "/assets/images/avatar/avatar-1.webp", name: "AI System" }, description: "" },
  { id: "2", title: "Cartel of 5 contractors flagged for bid rotation in road tenders", coverUrl: "/assets/images/cover/cover-2.webp", totalViews: 892, postedAt: /* @__PURE__ */ new Date(), author: { avatarUrl: "/assets/images/avatar/avatar-2.webp", name: "ML Engine" }, description: "" },
  { id: "3", title: "After-hours payment anomaly detected in Education Ministry", coverUrl: "/assets/images/cover/cover-3.webp", totalViews: 654, postedAt: /* @__PURE__ */ new Date(), author: { avatarUrl: "/assets/images/avatar/avatar-3.webp", name: "Fraud Detector" }, description: "" },
  { id: "4", title: "Same bank account linked to 47 welfare beneficiaries", coverUrl: "/assets/images/cover/cover-4.webp", totalViews: 1105, postedAt: /* @__PURE__ */ new Date(), author: { avatarUrl: "/assets/images/avatar/avatar-4.webp", name: "Pattern AI" }, description: "" },
  { id: "5", title: "Contract price 340% above market rate flagged in Delhi Jal Board", coverUrl: "/assets/images/cover/cover-5.webp", totalViews: 2340, postedAt: /* @__PURE__ */ new Date(), author: { avatarUrl: "/assets/images/avatar/avatar-5.webp", name: "Price Monitor" }, description: "" }
];
