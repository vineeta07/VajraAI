...
export function ProductsView({ darkMode }) {
  ...
  useEffect(() => {
    if (listenerSetRef.current) return void 0;
    listenerSetRef.current = true;
    socket.on("savings-updated", (newStats) => {
      setStats(newStats);
    ...
    socket.on("notification", (data) => {
      ...
      setTimeout(() => {
        toast.success(data.message, {
          id: "simulation-toast",
          // Use a fixed ID to prevent duplicates
          duration: 4e3,
          position: "top-right",
          style: {
            background: "#10b981",
        ...
        <div style={{
          ...
          <div style={{ padding: "20px", flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", flex: 1 }}>
              <div style={{ backgroundColor: isDarkMode ? "#1e293b" : "#f9fafb", borderRadius: "10px", padding: "12px" }}>
