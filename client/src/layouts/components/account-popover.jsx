...
export function AccountPopover({ data = [], sx, ...other }) {
  ...
  const userRole = user?.role === 'authority' ? 'Official' : 'Public';
  const photoURL = "/assets/images/avatar/avatar-1.webp";
  ...
  return <>
    ...
    >
      ...
      <Box sx={{ p: 1 }}>
        <Button fullWidth onClick={handleLogout} color="error" size="medium" variant="text">
          Logout
        </Button>
      </Box>
    </Popover>
