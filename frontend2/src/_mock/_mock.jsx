...
export const _boolean = (index) =>
  [
    true, false, true, false, true, true, true, false, false, true, false,
...
export const _description = (index) =>
  [
    ...
    'Andy shoes are designed to keeping in mind durability',
    'The beautiful range of Apple Naturalé with natural ingredients',
    "Boston's most advanced compression wear technology",
    'New ABC 13 9370, 13.3, 5th Gen CoreA5-8250U',
    'The Nagasaki Lander is the trademarked name',
    'Ergonomic executive chair upholstered in bonded leather',
    'The Football Is Good For Training And Recreational Purposes',
    'The automobile layout consists of a front-engine design',
  ][index];
